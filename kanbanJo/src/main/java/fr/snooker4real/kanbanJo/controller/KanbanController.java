...
public class KanbanController {
    ...
    public KanbanController(TacheService tacheService, DeveloppeurService developpeurService, ColonneService colonneService, TypeTacheService typeTacheService) {
        super();
